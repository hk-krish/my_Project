...
import { ColorPicker, Date, DateAndTime, MaximumLength, Month, Number, Password, Placeholder, Primary, StaticMagicalText, StaticText, Telephone, Time, URL, Week } from '../../../../../../../Constants'
        ...
        <Row>
            <Col>
                ...
                <Row className="mb-3">
                    ...
                    <Col sm="9"><Input type="password" placeholder="Password input" autoComplete="off"/></Col>
                </Row>
                <Row className="mb-3">
                ...
                <Row className="mb-3">
                    ...
                    <Col sm="9"><Input className="digits" id="example-datetime-local-input" type="datetime-local" defaultValue="2024-01-19T18:45:00" /></Col>
                </Row>
                <Row className="mb-3">
                    <Col sm="3"><Label>{Date}</Label></Col>
                    <Col sm="9"><Input className="digits" type="date" defaultValue="2024-09-01" /></Col>
                </Row>
                <Row className="mb-3">
                    <Col sm="3"><Label>{Month}</Label></Col>
                    <Col sm="9"><Input className="digits" type="month" defaultValue="2024-01" /></Col>
                </Row>
                <Row className="mb-3">
                    <Col sm="3"><Label>{Week}</Label></Col>
                    <Col sm="9"><Input className="digits" type="week" defaultValue="2024-W09" /></Col>
                </Row>
                <DatalistExample />
                <Row className="mb-3">
                ...
                <Row className="mb-3">
                    ...
                    <Col sm="2"><Input type="color" defaultValue={Primary} className='form-control-color' /></Col>
                </Row>
                <Row className="mb-3">
