...
import { DefaultStyleTitle } from "../../../../../Constants";
import { DefaultStyleFormData, DefaultStyleSubTitle } from "../../../../../Data/Forms&Table/Forms/FormControls";
...
const DefaultStyle = () => {
  return (
    <Col sm="12" xxl="6" className="box-col-6">
      <Card>
        <CommonCardHeader title={DefaultStyleTitle} span={DefaultStyleSubTitle} />
