...
import { AgreeTerms, Github, GiveFeedback, LinkedIn, SelectState } from "../../../../../../Constants";
    ...
    <Form className="stepper-three needs-validation custom-input" noValidate>
      <Row className="g-3">
        <Col sm="6">
          ...
          <Input name="linkedInLink" value={formData.linkedInLink} onChange={updateFormData} type="url" placeholder="https://linkedIn.com/yuri" />
        </Col>
        <Col sm="6">
          <Label>{Github}<span className="txt-danger">*</span></Label>
          <Input name="gitHubLink" value={formData.gitHubLink} onChange={updateFormData} type="url" placeholder="https://github.com/yuri" />
        </Col>
        <Col xs="12"> 
