...
import { AboveInformationCorrect, CardHolder, CardNumber, Cvv, Expiration, UploadDocumentation } from "../../../../../../../Constants";
      ...
      <Row className="g-3">
        ...
        <Col xs="12">
          <FormGroup check>
            ...
            <Label htmlFor="invalidCheck-c" check>{AboveInformationCorrect}</Label>
          </FormGroup>
        </Col>
      </Row>
    </Form>
