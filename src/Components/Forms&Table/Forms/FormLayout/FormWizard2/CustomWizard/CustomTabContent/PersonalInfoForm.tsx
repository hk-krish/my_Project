...
import { AgreeTerms, ContactNumber, Continue, Email, FirstName, LastName, State, ZipCode } from "../../../../../../../Constants";
    ...
    <Form onSubmit={(e) => e.preventDefault()} className="needs-validation" noValidate>
      <Row className="g-3">
        ...
        <Col xl="4" xs="12">
          ...
          <Input type="email" placeholder="wally@example.com" value={email} name="email" onChange={updateFormData} />
        </Col>
        <Col xl="5" sm="4">
          <Label>{State}</Label>
