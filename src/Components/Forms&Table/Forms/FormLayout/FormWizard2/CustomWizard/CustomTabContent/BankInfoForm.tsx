...
import { AadhaarNumber, ChooseBanks, Continue, PAN, Previous } from "../../../../../../../Constants";
import { ActiveCallbackProp } from "../../../../../../../Types/FormsType";
import { dynamicImage, Image } from "../../../../../../../Utils";
import { PopularBanksList } from "../../../../../../../Data/Forms&Table/Forms/FormLayout";
...
const BankInfoForm: React.FC<ActiveCallbackProp> = ({ activeCallBack }) => {
  ...
  const handleNextButton = () => {
    if (aadhaarNumber !== "" && panNumber !== "" && bankName !== "") activeCallBack(3);
