...
import { AgreeTerms, CVVNumber, CardHolder, CardNumber, Continue, Expiration, Previous } from "../../../../../../../Constants";
import { ActiveCallbackProp } from "../../../../../../../Types/FormsType";
import { ListOfYears } from "../../../../../../../Data/Forms&Table/Forms/FormLayout";
...
const PayDetailsForm: React.FC<ActiveCallbackProp> = ({ activeCallBack }) => {
  ...
  const handleNextButton = () => {
    if (cardHolderName !== "" && cardNumber !== "" && expiryDate !== "" && expiryYear !== "" && cvvNumber !== "") activeCallBack(5);
        ...
        <Col xs="12">
          <Row className="g-3">
            <Col md="6">
              ...
              <Row className="g-3">
                <Col md="6"><Input id="expiration" type="number" required placeholder="xx/xx" value={expiryDate} name="expiryDate" onChange={updateFormData} /></Col>
                <Col md="6">
