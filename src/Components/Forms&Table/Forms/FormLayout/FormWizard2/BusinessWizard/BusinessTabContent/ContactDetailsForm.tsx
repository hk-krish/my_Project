...
import { ContactDetails, Continue, Email, JoinOrganizationType, OrganizationDescription, OrganizationName, Previous } from "../../../../../../../Constants";
...
const ContactDetailsForm: React.FC<ActiveCallbackProp> = ({ activeCallBack }) => {
  ...
  const handleNextButton = () => {
    if (organizationName !== "" && email !== "" && description !== "" && organizationType !== "") activeCallBack(4);
