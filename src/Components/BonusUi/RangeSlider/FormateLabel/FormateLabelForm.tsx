            ...
            <div className="d-flex justify-content-center flex-wrap m-3" style={{ color: "#4AAD8A" }}>
              <Range
                ...
                renderThumb={({ props, index }) => (
                  <div {...props} className="d-flex justify-content-center align-items-center rounded-5" key={index} style={{ ...props.style, height: "20px", width: "20px", backgroundColor: "#4AAD8A", boxShadow: "0px 2px 6px #AAA" }}>
