            ...
            <div style={{ color: "#9560DD" }} className="d-flex justify-content-center flex-wrap m-3">
              <Range
                ...
                renderThumb={({ props, index }) => (
                  <div {...props} className="d-flex justify-content-center align-items-center rounded-5" key={index} style={{ ...props.style, height: "20px", width: "20px", border: "3px solid #9560DD", backgroundColor: "#9560DD", boxShadow: "0px 2px 6px #AAA" }}>
