            ...
            <div className="d-flex justify-content-center flex-wrap m-3">
              <Range
                ...
                renderThumb={({ props, isDragged, index }) => (
                  <div {...props} className="d-flex justify-content-center align-items-center rounded-5" key={index} style={{ ...props.style, height: "35px", width: "35px", backgroundColor: "#FFF", boxShadow: "0px 2px 6px #AAA" }}>
