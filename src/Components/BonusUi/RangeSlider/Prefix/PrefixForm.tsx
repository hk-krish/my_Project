          ...
          <Col md="10">
            <Range
              ...
              renderThumb={({ props, index }) => (
                <div {...props} className="d-flex justify-content-center align-items-center" key={`thumb-${index}`} style={{ ...props.style, height: "25px", width: "7px", backgroundColor: "#feb858", boxShadow: "0px 2px 6px #AAA" }}>
