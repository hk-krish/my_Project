  import { AllMemberType, ChatSliceType, ChatsTypes } from "../../Types/Applications";
import { createAsyncThunk, createSlice } from "@reduxjs/toolkit";
import axios from "axios";
import { Chats, ChatMembers } from "../../JsonData";
...
export const fetchChatMemberApiData = createAsyncThunk<AllMemberType[], void, {}>("/json-data/chat-members", async () => {
  const response = await axios.get(ChatMembers);
  return response.data;
});

export const fetchChatApiData = createAsyncThunk<ChatsTypes[], void, {}>("/json-data/chats", async () => {
