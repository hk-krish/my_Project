...
import { AllTaskType, TaskSliceType } from "../../Types/Applications";
import { Tasks } from "../../JsonData";
...
export const fetchTaskApiData = createAsyncThunk<AllTaskType[], void, {}>("/json-data/tasks", async () => {
