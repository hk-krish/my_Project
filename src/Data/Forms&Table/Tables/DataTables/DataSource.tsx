...
import { AjaxSourcedColumnsInterface, CustomCellInterFace, HtmlColumnsInterface, ServerSideProcessingInterface } from "../../../../Types/TablesType";
...
export const AjaxSourcedTableData: AjaxSourcedColumnsInterface[] = [
  {
    id: 1,
    name: "Angelica Ramos",
...
const handlePDFClick = (event: React.MouseEvent<HTMLAnchorElement>) => {
  ...
  const pdfUrl = `${process.env.PUBLIC_URL}/assets/pdf/sample.pdf`;
...
export const JavascriptSourcedTableData: AjaxSourcedColumnsInterface[] = [
  {
    id: 1,
    name: "Angelica Ramos",
    position: "Chief Executive Officer (CEO)",
