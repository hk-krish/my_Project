...
import { AddRowsTableProp, CustomNameImageProp, DeleteRowData, FilterDataTableProp } from "../../../../Types/TablesType";
...
export const DeleteTableRowData: DeleteRowData[] = [
  {
    name: "Airi Satou",
    id: 1,
    job: "Accountant",
    ...
    date: "2008/11/28",
    priority: <Badge color="light-danger">Urgent</Badge>,
    budget: "$162.700,00",
  },
  {
    name: "Angelica Ramos",
    ...
    date: "2009/10/09",
    priority: <Badge color="light-success">Low</Badge>,
    budget: "$1.200.000,00",
  },
  {
    name: "Bradley Greer",
    ...
    date: "2012/10/13",
    priority: <Badge color="light-primary">High</Badge>,
    budget: "$132.000,00",
  },
  {
    name: "Bruno Nash",
    ...
    date: "2011/05/03",
    priority: <Badge color="light-warning">Medium</Badge>,
    budget: "$163.500,00",
  },
  {
    name: "Caesar Vance",
...
export const CustomNameImage: React.FC<CustomNameImageProp> = ({ src, name }) => {
  return (
    <Fragment>
      <Image className="img-fluid table-avtar" src={`${dynamicImage(`user/${src}`)}`} alt="userImage"/>
      {name}
    </Fragment>
  );
};
