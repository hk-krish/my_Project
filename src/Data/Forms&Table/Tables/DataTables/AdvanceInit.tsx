...
import { CustomRowCreateInterFace, RowCreateCallBackData, StockResultColumnType } from "../../../../Types/TablesType";
...
const CustomCell: React.FC<CustomRowCreateInterFace> = ({ value }) => {
  return <span className={value > "150000" ? "highlight" : value < "40000" ? "danger" : ""}>${value}</span>;
};
